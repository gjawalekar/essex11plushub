...
const E11CONFIG = {
  ...
  products: [
    {
      id:           'core-set-1',
      name:         'Core Concepts Weekly Lessons — Set 1',
      subtitle:     'Weeks 01–08',
      description:  'Eight guided weekly lessons covering Science, Music, Art & Design, PE, Design & Technology and Computing, with practice questions, answer keys and score trackers.',
      badge:        'Weeks 01–08',
      badgeColor:   '#EAF5F6',
      emoji:        '◆',
      price:        21.00,
    ...
    {
      id:           'core-set-2',
      name:         'Core Concepts Weekly Lessons — Set 2',
      subtitle:     'Weeks 09–16',
      description:  'Eight guided weekly lessons covering Languages, English, FSCE application skills, Maths, History and Geography, with practice questions, answer keys and score trackers.',
      badge:        'Weeks 09–16',
      badgeColor:   '#EDEDF7',
      emoji:        '◆',
      price:        21.00,
